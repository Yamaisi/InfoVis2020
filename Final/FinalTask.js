...
//    screen.renderer.setClearColor( new THREE.Color( "black" ) );
    ...
    var raycaster_material = new THREE.ShaderMaterial( {
        ...
        uniforms: {
            ...
            reflection_num: {type: 'int', value: 1},
            para_ka: {type: 'float', value: document.getElementById("ka").value },
            para_kd: {type: 'float', value: document.getElementById("kd").value },
            para_ks: {type: 'float', value: document.getElementById("ks").value },
            para_n:  {type: 'float', value: document.getElementById("n").value  },
            para_m:  {type: 'float', value: document.getElementById("m").value  },
            para_F0: {type: 'float', value: document.getElementById("F0").value },
        }
    });
    ...
    document.getElementById('change-reflect-button')
        .addEventListener('click', function() {
        	screen.scene.remove( raycaster_mesh );
        	var element = document.getElementById("reflect");
        	var raycaster_material = new THREE.ShaderMaterial( {
        		vertexShader: document.getElementById( 'raycaster.vert' ).textContent,
        		fragmentShader: document.getElementById( 'raycaster.frag' ).textContent,
        		side: THREE.FrontSide,
        		uniforms: {
            		...
            		camera_position: { type: 'v3', value: screen.camera.position },
           			background_color: { type: 'v3', value: new THREE.Vector3().fromArray( screen.renderer.getClearColor().toArray() ) },
            		reflection_num: {type: 'int', value: element.reflection.value},
            		para_ka: {type: 'float', value: document.getElementById("ka").value },
            		para_kd: {type: 'float', value: document.getElementById("kd").value },
            		para_ks: {type: 'float', value: document.getElementById("ks").value },
            		para_n:  {type: 'float', value: document.getElementById("n").value  },
